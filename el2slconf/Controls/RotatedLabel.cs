...
namespace Bng.EL2SL.Configurator
{
    ...
    {
        private int _mRotateAngle = 0;
        private string _mNewText = string.Empty;

        public int RotateAngle { get { return _mRotateAngle; } set { _mRotateAngle = value; Invalidate(); } }
        public string NewText { get { return _mNewText; } set { _mNewText = value; Invalidate(); } }
